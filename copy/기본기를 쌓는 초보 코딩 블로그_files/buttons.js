...
!(function () {
  ...
  var e = window.document,
    ...
    w = function (e, t) {
      return (
        "@media(prefers-color-scheme:" + e + "){" + m[v(m, t) ? t : e] + "}"
      );
    },
    x = {
      "mark-github": {
    ...
    C = function (e, t, o) {
      var r = g(e.ownerDocument),
        ...
        n =
          ...
          (function (e) {
            ...
            return (
              m[v(m, t["no-preference"]) ? t["no-preference"] : "light"] +
              w("light", t.light) +
              w("dark", t.dark)
            );
          })(t["data-color-scheme"]);
      ...
      if (
        s.length < i.length ||
        ("." + s).substring(s.length - i.length) !== "." + i
      )
        return (l.href = "#"), (l.target = "_self"), void o(c);
      var f = (" /" + l.pathname).split(/\/+/);
      if (
        ((((s === i || s === "gist." + i) && "archive" === f[3]) ||
          (s === i && "releases" === f[3] && "download" === f[4]) ||
          s === "codeload." + i) &&
          (l.target = "_top"),
        /^true$/i.test(t["data-show-count"]) && s === i)
      ) {
        var h, u;
  ...
  t.protocol + "//" + t.host + t.pathname === n
    ? C(e.body, d(window.name || t.hash.replace(/^#/, "")), function () {})
    : (function (t) {
        if (
